...
const notes = [
  { id: 1, title: 'The Future of AI', summary: 'Exploring the potential impact of artificial intelligence on various industries...', content: 'Full content of the AI article...' },
  { id: 2, title: 'Web Development Trends 2024', summary: 'Latest trends in web development including new frameworks and technologies...', content: 'Full content of web development trends...' },
  { id: 3, title: 'Sustainable Energy Solutions', summary: 'Innovative approaches to renewable energy and their global implications...', content: 'Full content of sustainable energy article...' },
  { id: 4, title: 'Cybersecurity Best Practices', summary: 'Essential strategies for protecting digital assets and personal information...', content: 'Full content of cybersecurity article...' },
  { id: 5, title: 'The Rise of Remote Work', summary: 'How remote work is reshaping the modern workplace and its long-term effects...', content: 'Full content of remote work article...' },
  { id: 6, title: 'Blockchain Beyond Cryptocurrency', summary: 'Exploring blockchain applications in various sectors beyond digital currencies...', content: 'Full content of blockchain article...' },
...
export default function Dashboard() {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      setSidebarWidth(Math.min(Math.max(newWidth, 20), 80)) // Limit between 20% and 80%
    }
  ...
  return (
    <div className={`flex h-screen ${isDarkMode ? 'dark bg-gray-900 text-gray-100' : 'bg-gray-100 text-gray-800'}`}>
          ...
          {filteredNotes.map(note => (
            <li key={note.id}>
              <button
                ...
                className="w-full text-left px-4 py-2 rounded-lg hover:bg-indigo-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-400 transition duration-150 ease-in-out"
              >
      ...
      {/* Main Content */}
      <div className="flex-1 p-8 overflow-y-auto relative" style={{ width: `${100 - sidebarWidth}%` }}>
        <div className="grid grid-cols-2 gap-6">
          {filteredNotes.map(note => (
            ...
            >
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 line-clamp-3">{note.summary}</p>
            </motion.div>
          ))}
        </div>
        {/* New Note Button */}
